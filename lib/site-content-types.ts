// Types and defaults only — no server-only imports here.
// Safe to import from BOTH client components (e.g. the admin editor form)
// and server components. The actual data-fetching function that needs
// cookies()/next-headers lives in lib/site-content.ts (server-only).
